            ...
            <ul class="menu-nav">
                ...
                <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                    ...
                    <div class="menu-submenu">
                        ...
                        <ul class="menu-subnav">
                            <li class="menu-item" aria-haspopup="true">
                                <a href="{{url('jenis_gadget')}}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                    </i>
                                    <span class="menu-text">Jenis Gadget</span>
                                </a>
                            </li>
                            <li class="menu-item" aria-haspopup="true">
                                <a href="{{url('merek_gadget')}}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                    </i>
                                    <span class="menu-text">Merek Gadget</span>
                                    <!-- <span class="menu-label">
                                        <span class="label label-danger label-inline">new</span>
                                    </span> -->
                                </a>
                            ...
                            <li class="menu-item" aria-haspopup="true">
                                <a href="{{url('type_gadget')}}" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                    </i>
                                    <span class="menu-text">Type Gadget</span>
                                </a>
                            </li>
                        </ul>
                    </div>
